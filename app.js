        ...
        stu.forEach((student,index)=>{
            ...
            row.innerHTML = `
                    ...
                    <td class="d-flex py-3 justify-content-center">
                        <span onclick="viewStu(${index}})" class="btn btn-primary d-flex justify-content-center align-items-center mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi me-1 bi-eye" viewBox="0 0 16 16">
